...
log "patched keypad path: /system/usr/keylayout/mtk-kpd.kl"
...

{
  ...
  echo "Patched keypad SHA   : b85deb46f0ac9ebeb49f22a442ef442fc7adc612dbf075e52ddf178695969ec4"
  echo "Volume scan mapping  : 115=MEDIA_FAST_FORWARD, 114=MEDIA_REWIND"
