...
class Y2RowIconsTest {
    ...
    private val stableActionKeys = listOf(
        ...
        "previous_threshold", "queue", "queue_clear", "queue_clear_upcoming",
    ...
    private val parameterisedActionKeys = listOf(
        ...
        "np_track_options:1", "playlist:5", "playlist_add:5", "playlist_delete:5",
        "queue_down:0", "queue_play:0", "queue_remove:0", "queue_up:0",
        "sort:title", "storage:sdcard", "timeout:15000", "track_album:1",
        "track_artist:1", "track_browse:1", "track_details:1", "track_favorite:1",
        "track_next:1", "track_playlist:1", "track_queue:1", "track_remove_playlist:5:1",
    ...
    fun `every destructive row carries the remove icon`() {
        listOf(
            "queue_clear", "queue_clear_upcoming", "history_clear",
